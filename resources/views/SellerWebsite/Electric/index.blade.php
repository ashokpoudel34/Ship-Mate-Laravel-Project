...
<head>
  ...
  <!-- bootstrap core css -->
  <link rel="stylesheet" type="text/css" href="{{ asset('template-elec/assets/css/bootstrap.css') }}" />
  <!-- font awesome style -->
  <link rel="stylesheet" type="text/css" href="{{ asset('template-elec/assets/css/font-awesome.min.css') }}" />

  <!-- Custom styles for this template -->
  <link href="{{ asset('template-elec/assets/css/style.css') }}" rel="stylesheet" />
  <!-- responsive style -->
  <link href="{{ asset('template-elec/assets/css/responsive.css') }}" rel="stylesheet" />
...
<body>
    ...
    <section id="home" class="slider_section ">
      <div class="container ">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="img-box">
              <img src="{{ asset('template-elec/assets/images/slider-img.png') }}" alt="">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-7 col-md-6">
          <div class="img-box">
            <img src="{{ asset('template-elec/assets/images/about-img.jpg') }}" alt="">
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="professional_section layout_padding">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="img-box">
            <img src="{{ asset('template-elec/assets/images/professional-img.png') }}" alt="">
          </div>
        </div>
        <div class="col-md-6 ">
          <div class="detail-box">
    ...
    <div class="container ">
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            <div class="img-box">
              <img src="{{ asset('template-elec/assets/images/s1.png') }}" alt="" />
            </div>
            <div class="detail-box">
              <h5>
                Maintenance
        ...
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            <div class="img-box">
              <img src="{{ asset('template-elec/assets/images/s2.png') }}" alt="" />
            </div>
            <div class="detail-box">
              <h5>
                Electrical
        ...
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            <div class="img-box">
              <img src="{{ asset('template-elec/assets/images/s3.png') }}" alt="" />
            </div>
            <div class="detail-box">
              <h5>
                Plumbing
        ...
        <div class="owl-carousel">
          <div class="item">
            <div class="box">
              <div class="client_id">
                <div class="img-box">
                  <img src="{{ asset('template-elec/assets/images/client-1.jpg') }}" alt="">
                </div>
          ...
          <div class="item">
            <div class="box">
              <div class="client_id">
                <div class="img-box">
                  <img src="{{ asset('template-elec/assets/images/client-2.jpg') }}" alt="">
                </div>
                <div class="client_detail">
                  <div class="client_info">
                    <h6>
  ...
  <script src="{{ asset('template-elec/assets/js/jquery-3.4.1.min.js') }}"></script>
  <script src="{{ asset('template-elec/assets/js/bootstrap.js') }}"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js">
  </script>
  <script src="{{ asset('template-elec/assets/js/custom.js') }}"></script>
  <!-- Google Map -->
