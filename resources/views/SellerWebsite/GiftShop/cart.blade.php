                ...
                <div class="col-md-10 mx-auto">
                    <table class="table bg-white shadow-md">
                        ...
                        <tr class="align-middle">
                            <td>1</td>
                            <td>
                                <img class="max-100" src="{{ asset('template-giftshop/assets/images/product/p3.jpg') }}" alt="">
                            </td>
                        ...
                        <tr class="align-middle">
                            <td>2</td>
                            <td>
                                <img class="max-100" src="{{ asset('template-giftshop/assets/images/product/p4.jpg') }}" alt="">
                            </td>
