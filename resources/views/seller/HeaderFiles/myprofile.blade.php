              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{ $data->category }}</div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><a href="{{ url($data->link) }}">shipmate.ashok.live/{{ $data->link }}</a></div>
                  </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <!-- Profile Edit Form -->
                  <form action="{{ route('site.portal.profile') }}" class="effect2" method="POST" enctype="multipart/form-data">
                  @csrf  
                  <input type="hidden" name="tabId" value="tab2">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="category" type="text" class="form-control" id="Category" value="{{ $data->category }}">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="mobile" type="text" class="form-control" id="Mobile" value="{{ $data->mobile }}">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        <input name="link" type="text" class="form-control" id="Link" value="{{ $data->link }}">
                      </div>
                    </div>
