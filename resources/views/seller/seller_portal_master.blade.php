...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('client_css/SellerPortal/dashboard.css') }}">
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="{{ route('site.seller.seller_login') }}" class="list-group-item list-group-item-action bg-transparent text-danger fw-bold"><i
