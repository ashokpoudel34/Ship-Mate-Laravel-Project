...
<body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navbarNav" style="font-size: 1.4rem;">
            <ul class="navbar-nav d-flex">
              <li class="nav-item">
                <a class="nav-link text-white" href="{{ route('site.seller.pricing') }}">Pricing</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link text-white" href="{{ route('site.user.askEveryone') }}">Login/SignUp</a>
              </li>
              <li class="nav-item">
    ...
    <main>
        {{-- <h2><strong>Shop smart, live well.</strong></h2> --}}
        @yield('content')
    </main>
