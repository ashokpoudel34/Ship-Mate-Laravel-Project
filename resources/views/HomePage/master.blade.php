  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="{{ route('site.home')}}#hero" class="active">Home</a></li>
          <li><a href="{{ route('site.home')}}#about">About</a></li>
          <li><a href="{{ route('site.home')}}#service">Services</a></li>
          <li><a href="{{ route('site.home')}}#pricing">Pricing</a></li>
          ...
          <li><a class="get-a-quote" href="{{ route('site.seller.seller_login')}}">Login</a></li>
        </ul>
      </nav><!-- .navbar -->
  ...
  <div class="row gy-4">
    ...
    <div class="col-lg-2 col-6 footer-links">
      ...
      <ul>
        ...
        <li><a href="{{ route('site.home')}}#service">Services</a></li>
        <li><a href="{{ route('site.home')}}#">Terms of service</a></li>
        <li><a href="{{ route('site.home')}}#">Privacy policy</a></li>
      </ul>
    </div>
    ...
    <div class="col-lg-2 col-6 footer-links">
      <h4>Our Services</h4>
      <ul>
        <li><a href="{{ route('site.home')}}#service">Web Design</a></li>
        <li><a href="{{ route('site.home')}}#service">Web Development</a></li>
        <li><a href="{{ route('site.home')}}#service">Product Management</a></li>
        <li><a href="{{ route('site.home')}}#service">Marketing</a></li>
        <li><a href="{{ route('site.home')}}#service">Graphic Design</a></li>
      </ul>
    </div>
