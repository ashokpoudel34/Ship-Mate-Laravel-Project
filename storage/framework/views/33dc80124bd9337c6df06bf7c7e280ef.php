...
<body>
    <header>
        <h1><i class="bi bi-bag-fill"></i><a href="<?php echo e(route('site.home')); ?>"> Ship-Mate</a></h1>
        ...
        <nav class="" id="navbar">
            ...
            <li><a href="<?php echo e(route('site.user.askEveryone')); ?>">Login/SignUp</a></li>
...
</html><?php /**PATH D:\01PARUL\ASMP_Project\project_ASMP1\ship-mate\resources\views/admin/admin_master.blade.php ENDPATH**/ ?>