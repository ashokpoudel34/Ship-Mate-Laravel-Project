                        ...
                        <div class="row">
                                ...
                                <div class="bg-white p-2 shadow-md">
                                   <div class="text-center">
                                        <a href="<?php echo e(route($data->link . 'giftshop.detail')); ?>">
                                            <img src="<?php echo e(asset('template-giftshop/assets/images/product/p1.jpg')); ?>" alt="">
                                       </a>
                                   </div>
                            ...
                            <div class="col-lg-4 col-sm-6 mb-4">
                                <div class="bg-white p-2 shadow-md">
                                    <div class="text-center">
                                        <a href="<?php echo e(route($data->link . 'giftshop.detail')); ?>">
                                            <img src="<?php echo e(asset('template-giftshop/assets/images/product/p2.jpg')); ?>" alt="">
                                        </a>
                                    </div>
                                    <div class="detail p-2">
                                        <h4 class="mb-1 fs-5 fw-bold">Personalised Birthday Easel</h4>
                            ...
                            <div class="col-lg-4 col-sm-6 mb-4">
                                <div class="bg-white p-2 shadow-md">
                                    <div class="text-center">
                                        <a href="<?php echo e(route($data->link . 'giftshop.detail')); ?>">
                                            <img src="<?php echo e(asset('template-giftshop/assets/images/product/p3.jpg')); ?>" alt="">
                                        </a>
                                    </div>
                                    <div class="detail p-2">
                                        <h4 class="mb-1 fs-5 fw-bold">Personalised Birthday Easel</h4>
                            ...
                            <div class="col-lg-4 col-sm-6 mb-4">
                                <div class="bg-white p-2 shadow-md">
                                    <div class="text-center">
                                        <a href="<?php echo e(route($data->link . 'giftshop.detail')); ?>">
                                            <img src="<?php echo e(asset('template-giftshop/assets/images/product/p4.jpg')); ?>" alt="">
                                        </a>
                                    </div>
                                    <div class="detail p-2">
                                        <h4 class="mb-1 fs-5 fw-bold">Personalised Birthday Easel</h4>
...
<?php echo $__env->make('SellerWebsite.GiftShop.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ashokpoudel/Documents/Web Devlopment/Laravel/Shipmate with Git/shipmate/resources/views/SellerWebsite/GiftShop/product.blade.php ENDPATH**/ ?>