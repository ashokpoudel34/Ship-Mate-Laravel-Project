...
<?php echo csrf_field(); ?>
    ...
    <?php if($error = $errors->first('err')): ?>
    <div class="col-12">
      <p class="small mb-0">Forgot Password? <a href="<?php echo e(route('site.seller.seller_reset')); ?>">Reset Password</a></p>
    </div>
    <?php else: ?>
    <div class="col-12">
...
<?php echo $__env->make('HomePage.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ashokpoudel/Documents/Web Devlopment/Laravel/Shipmate with Git/shipmate/resources/views/LoginSignUp/seller_login.blade.php ENDPATH**/ ?>