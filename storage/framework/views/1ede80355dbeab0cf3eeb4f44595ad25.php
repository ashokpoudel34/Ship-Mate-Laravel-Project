    ...
    <?php $__env->startSection('content'); ?>
        <div class="form-div right-side">
            ...
            <form action="" class="effect2">
                ...
                <p class="noAcc">Don't have an account?&nbsp;&nbsp;<a href="<?php echo e(route('site.buyer.buyer_signup')); ?>"><strong>  Signup <i class="bi bi-pencil-square"></i></strong></a></p>
            </form>
        </div>
    <?php $__env->stopSection(); ?>


<?php echo $__env->make('buyer.buyer_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\01PARUL\ASMP_Project\project_ASMP1\ship-mate\resources\views/buyer/buyer_login.blade.php ENDPATH**/ ?>