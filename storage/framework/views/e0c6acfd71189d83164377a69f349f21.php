    ...
    <?php $__env->startSection('content'); ?>
        <div class="form-div right-side">
            ...
            <form action="" class="effect2">
                ...
                <p>Don't have an account? <a href="<?php echo e(route('site.user.signup')); ?>"><strong>  Signup</strong></a></p>
            </form>
        </div>
    <?php $__env->stopSection(); ?>


<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\01PARUL\ASMP_Project\project_ASMP1\ship-mate\resources\views/user_login.blade.php ENDPATH**/ ?>