<!doctype html>
    ...
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo e(asset('template-giftshop/assets/images/fav.png')); ?>" type="image/x-icon">
        <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700;800;900&amp;display=swap" rel="stylesheet">
        <link rel="shortcut icon" href="<?php echo e(asset('template-giftshop/assets/images/fav.jpg')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('template-giftshop/assets/css/bootstrap.min.css')); ?>">
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.7.2/font/bootstrap-icons.css">
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('template-giftshop/assets/css/style.css')); ?>" />
    </head>
    <bod>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="d-inline-flex pt-0 pt-md-2 fs-6">
                                <li class="p-2 "><i class="bi bi-envelope"></i><?php echo e($data->email); ?></li>
                                <li class="p-2 d-none d-md-block"><i class="bi bi-headphones"></i><?php echo e($data->mobile); ?></li>
                            </ul>
                        </div>
                        <div class="col-md-4 d-flex align-items-end">
                            <ul class="ms-auto d-inline-flex">
                                <li class="p-2"><a  href="<?php echo e(route($data->link . 'giftshop.login')); ?>"><button class="btn px-4 btn-danger">Login</button></a></li>
                                <li class="p-2"><a  href="<?php echo e(route($data->link . 'giftshop.signup')); ?>"><button class="btn px-4 btn-outline-danger">Sign Up</button></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="container">
                     <div class="row">
                         <div class="col-md-3 col-9 pt-1 pb-2">
                            <a href="<?php echo e(route($data->link . 'homepage')); ?>">
                                <img class="logo" src="<?php echo e(asset('template-giftshop/assets/images/logo.jpg')); ?>" alt="">
                            </a> 
                         </div>
                         ...
                         <div class="col-md-3 col-3 pt-1 text-end">
                             <a href="<?php echo e(route($data->link . 'giftshop.cart')); ?>">
                    ...
                    <ul id="menu" class=" navcol fw-bold d-none d-md-inline-flex">
                        <li class="p-21 px-4"><a class="text-white" href="">Categories <i class="bi pt-2 bi-chevron-down"></i></a> 
                          ...
                          <li class="p-21 px-4"><a class="text-white" href="">Pages <i class="bi pt-2 bi-chevron-down"></i></a> 
                            <div class="inner-div">
                                <ul class="">
                                    <li><a href="<?php echo e(route($data->link . 'homepage')); ?>">Home</a></li>
                                    <li><a href="<?php echo e(route($data->link . 'giftshop.about')); ?>">About US</a></li>
                                    <li><a href="<?php echo e(route($data->link . 'giftshop.contact')); ?>">Contact US</a></li>
                                    <li><a href="<?php echo e(route($data->link . 'giftshop.product')); ?>">Product Listing</a></li>
                                    <li><a href="<?php echo e(route($data->link . 'giftshop.detail')); ?>">Product Detail</a></li>
                                    <li><a href="<?php echo e(route($data->link . 'giftshop.login')); ?>">login</a></li>
                                    <li><a href="<?php echo e(route($data->link . 'giftshop.signup')); ?>">Sign Up</a></li>
                                    <li><a href="<?php echo e(route($data->link . 'giftshop.cart')); ?>">Cart</a></li>
                                </ul>
                            </div>
                        </li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 foot-post">
                        ...
                        <div class="post-row">
                            <div class="image">
                                <img src="<?php echo e(asset('template-giftshop/assets/images/blog/1.jpg')); ?>" alt="">
                            </div>
                        ...
                        <div class="post-row">
                            <div class="image">
                                <img src="<?php echo e(asset('template-giftshop/assets/images/blog/7.jpg')); ?>" alt="">
                            </div>
                        ...
                        <div class="post-row">
                            <div class="image">
                                <img src="<?php echo e(asset('template-giftshop/assets/images/blog/6.jpg')); ?>" alt="">
                            </div>
                            <div class="detail ps-2">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras hendrerit </p>
                            </div>
    ...
    <script src="<?php echo e(asset('template-giftshop/assets/js/jquery-3.2.1.min.js')); ?>"></script>
    <script src="<?php echo e(asset('template-giftshop/assets/js/popper.min.js')); ?>"></script>
    <script src="<?php echo e(asset('template-giftshop/assets/js/bootstrap.bundle.min.js')); ?>"></script>
    <script src="<?php echo e(asset('template-giftshop/assets/plugins/scroll-fixed/jquery-scrolltofixed-min.js')); ?>"></script>
    <script src="<?php echo e(asset('template-giftshop/assets/plugins/testimonial/js/owl.carousel.min.js')); ?>"></script>
    <script src="<?php echo e(asset('template-giftshop/assets/js/script.js')); ?>"></script>

</html><?php /**PATH /Users/ashokpoudel/Documents/Web Devlopment/Laravel/Shipmate with Git/shipmate/resources/views/SellerWebsite/GiftShop/master.blade.php ENDPATH**/ ?>