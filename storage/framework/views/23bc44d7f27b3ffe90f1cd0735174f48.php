...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-blue-500 shadow-lg">
        <div class="container-fluid">
          <a class="navbar-brand d-flex align-items-center" href="<?php echo e(route('site.home')); ?>">
            ...
            <span class="ms-3 fw-bold text-white" style="font-size: 2rem;">Ship-Mate</span>
          </a>
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navbarNav" style="font-size: 1.4rem;">
            <ul class="navbar-nav d-flex">
              ...
              <li class="nav-item">
                <a class="nav-link text-white" href="<?php echo e(route('site.user.askEveryone')); ?>">Login/SignUp</a>
              </li>
              <li class="nav-item">
...
</html><?php /**PATH C:\Users\ashok\Desktop\Ship-Mate-Laravel-Project\resources\views/master.blade.php ENDPATH**/ ?>