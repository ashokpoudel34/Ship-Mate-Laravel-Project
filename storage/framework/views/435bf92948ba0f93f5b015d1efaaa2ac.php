...
<?php if($errors->any()): ?>
    ...
    <?php endif; ?> -->
    <form action="<?php echo e(route($data->link . 'giftshop.resetpassword')); ?>" method="POST" class="row g-3 ">
        <?php echo csrf_field(); ?>
        <div class="col-12">
...
<?php echo $__env->make('SellerWebsite.GiftShop.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ashokpoudel/Documents/Web Devlopment/Laravel/Shipmate with Git/shipmate/resources/views/SellerWebsite/GiftShop/setpassword.blade.php ENDPATH**/ ?>