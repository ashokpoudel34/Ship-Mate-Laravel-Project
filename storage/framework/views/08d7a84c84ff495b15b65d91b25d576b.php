<?php $__env->startSection('content'); ?>
  ...
  <section class="bg-gradient-to-r from-blue-500 to-blue-500 text-white py-40 px-4 md:px-12 lg:px-24">
    <div class="max-w-4xl mx-auto">
      ...
      <a href="<?php echo e(route('site.user.askEveryone')); ?>" class="bg-white text-indigo-500 py-3 px-6 rounded-full font-medium text-lg shadow-lg hover:shadow-xl transition duration-300">Get Started Now</a>
    </div>
  </section>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ashok\Desktop\Ship-Mate-Laravel-Project\resources\views/common_home.blade.php ENDPATH**/ ?>