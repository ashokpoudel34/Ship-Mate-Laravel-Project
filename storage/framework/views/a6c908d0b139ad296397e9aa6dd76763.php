...
<?php $__env->startSection('content'); ?>
    ...
    <div class="form-div right-side">
        ...
        <form action="<?php echo e(route('site.seller.seller_signup')); ?>" id="registration-form" method="POST" enctype="multipart/form-data">
...
<?php echo $__env->make('seller.seller_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\01PARUL\ASMP_Project\project_ASMP1\ship-mate\resources\views/seller/seller_signup.blade.php ENDPATH**/ ?>