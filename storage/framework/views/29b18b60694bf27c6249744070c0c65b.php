...
<?php $__env->startSection('content'); ?>
    ...
    <div class="form-div right-side">
        ...
        <h1>Signup <i class="bi bi-pencil-square"></i></h1>
        
        <form action="<?php echo e(route('site.user.signup')); ?>" id="registration-form" method="POST" enctype="multipart/form-data">
...
<?php echo $__env->make('user.user_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\01PARUL\ASMP_Project\project_ASMP1\ship-mate\resources\views/user/user_signup.blade.php ENDPATH**/ ?>